...
void QmitkSegmentationView::CreateQtPartControl(QWidget* parent)
{
   ...
   m_Controls->m_ManualToolSelectionBox2D->SetDisplayedToolGroups(tr("Add Subtract Correction Paint Wipe 'Region Growing' Fill Erase 'Live Wire' '2D Fast Marching' '3D Cell Annotator'").toStdString());
